...
<html>
	<head>
		<title>FesKteva - perfiles</title>
		<meta http-equiv="content-type" content="text/html; charset=utf-8" />
		<meta name="description" content="Modos en que puedes utilizar FesKteva, la herramienta 3D que te ayuda a diseñar tu casa." />
...
-->
							<nav id="nav">
								<ul>
									...
									<li class="current_page_item"><a href="perfiles.jsp">Perfiles</a></li><li><a href="galeria.jsp">Galería</a></li>
<!--
							...
							<!-- Content -->
								...
								<article class="first last">
									...
									<table class="tablaperfiles">
										...
										%>" class="button">Empezar a diseñar!</a></td><td><a href="registro.html" class="button">Registrarse</a></td><td><a href="registro.html" class="button">Registrarse</a></td></tr>
									</table>
